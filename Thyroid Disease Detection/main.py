...
app.config["MONGO_URI"] = 'mongodb://127.0.0.1:27017/ML_Disease_Detection'
...
def predict():
    ...
    return render_template('result.html', prediction_text='{}'.format(res_Val),bloodParam = values2 )
