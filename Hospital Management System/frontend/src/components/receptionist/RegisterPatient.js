...
const RegisterPatient = (props) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const url = `${host}api/auth/patient/registerpatient`;
        const response = await fetch(url, {
            method: 'POST',
            headers: {
                'Content-type': "application/json"
        ...
        if (json.success) {
            ...
            alert("Patient With Same Email Already Exists !!!");
        }
    }
  ...
  return (
    ...
    <div className="card container col-md-12">
                <div className="card-body">
                    <h4 className='text-center mb-4'>Register A New Patient</h4>
                    <form className="row g-3">
                        ...
                        {displayDetails && <div className="row g-3">
                            ...
                            <div className="col-12">
                                <button type="submit" className="btn btn-primary my-3" onClick={handleSubmit}>Register Patient</button>
                            </div>
                        </div>}
                    </form>
                </div>
